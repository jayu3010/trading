...
const Customers = () => {
    ...
    const handleKeyUpSearch = (e) => {
        setIsSearch(true);
        const data = customers.filter((b) => b?.fullname.toUpperCase().includes(e.target.value.toUpperCase()));
    ...
    tableData =data.sort((a, b) => a.fullname > b.fullname ? 1:-1).map((customer, i) => ({
        id: i + 1,
